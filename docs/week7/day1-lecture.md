...
| (2) | 쉬는 시간 | 5분 |
| (3) | Session 1-2. 데이터 적재 — TabFormer를 내 BigQuery에 올리기 | 60분 |
| (4) | 쉬는 시간 | 5분 |
| (5) | Session 1-3. 데이터 확인과 기초 집계 — SQLD 지식으로 BigQuery 달리기 | 60분 |
...
- 반전 하나: **`LIMIT 10`을 붙여도 스캔량은 줄지 않습니다.** 결과 화면에 10행만 보여줄 뿐, 스캔은 이미 끝난 뒤입니다. (이 이야기는 Session 1-3에서 직접 확인합니다.)
